'use strict';
const { retrieveOneStation } = require('./retrieveOneStation');
...
const data_sources = async () => {
  ...
  const oneStationBasedOnStationId = await retrieveOneStation(stationId);
  console.log(`1st requirement => Return the information for one station given a station id. i.e <${stationId}>: `, oneStationBasedOnStationId)
  //******************************************************************** */
